...
print ("Use this program to enter your SAT scores and find out if you fit into popular NC college's SAT ranges!") #explaining what interaction will occur between the user and the program
